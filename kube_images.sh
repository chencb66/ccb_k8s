...
docker tag chencb66/kube-controller-manager:v1.1 k8s.gcr.io/kube-controller-manager:v1.13.1
...
docker tag chencb66/kubernetes-dashboard:v1.10.1 k8s.gcr.io/kubernetes-dashboard:v1.10.1
